...
# SECURITY WARNING: keep the secret key used in production secret! '2ii4ve965del$j(s38!-dyx%*(y2ul-xfkx6hb%y-#)fzix1r2'
...
AUTH_USER_MODEL = 'user_management.ExtendedUser'
